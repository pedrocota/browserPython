...
f = open("index.html", "br+") #vai receber o HTML com HTTP header
...
#path = input('Qual o caminho completo do arquivo?')
url = 'file://' + os.path.realpath('index.html')
#url = 'file://C:/Users/phbcf/OneDrive/Área de Trabalho/Python Browser/index'
